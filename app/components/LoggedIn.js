...
export default class LoggedIn extends Component {
  render() {
    return (
        <CardMedia className={classes.root} image={'./assets/_Links/elegant-latest-dota-2-2013-pc-game-hd-wallpapers-dota-2-of-keeper-of-the-light-dota-2-wallpaper-hd.jpg'}>
